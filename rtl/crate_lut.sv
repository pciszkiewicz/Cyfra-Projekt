...
// Tabela położeń (LUT) zamieniająca indeks skrzynki (0-31) na wyśrodkowane pozycje (X, Y) na mapie 2048x2048
module crate_lut (
    input  logic [4:0]  crate_id, // Indeks skrzynki (0 do 31)
    output logic [11:0] crate_x,  // Wyjściowa globalna pozycja X na mapie (w pikselach)
    output logic [11:0] crate_y   // Wyjściowa globalna pozycja Y na mapie (w pikselach)
);
