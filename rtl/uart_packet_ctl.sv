...
module uart_packet_ctl (
    ...
    // =========================================================================
    // NADAJNIK (TX FSM) - Pakowanie i wysyłanie
    // =========================================================================
    ...
    always_comb begin
        ...
        tx_start_nxt   = 1'b0; // Domyślnie zerujemy impuls wysyłania
        ...
        case (tx_state_reg)
            ...
            TX_WAIT_HP:  begin if (!tx_busy) tx_state_nxt = TX_IDLE; end
    ...
    // =========================================================================
    // ODBIORNIK (RX FSM) - Odbieranie i rozpakowywanie
    // =========================================================================
    ...
    always_comb begin
        ...
        if (rx_ready) begin
            case (rx_state_reg)
                RX_IDLE: begin
                    if (rx_data == HEADER_BYTE) 
                        rx_state_nxt = RX_GET_XH;
                end
                ...
                RX_GET_HP: begin 
                    // Aktualizacja danych w systemie dopiero po odebraniu całej paczki
                    enemy_hp_nxt = rx_data;
